...
Window {
    ...
    Component.onCompleted: {
        i18n.domain = "transmission.davidv.dev"
    }
    ...
    Item {
        ...
        Connections {
            ...
            onImportRequested: {
                ...
                python.call('main.movefile',
                            [torrentimport.activeConTransfer.items[0].url.toString(
                                 )], function (returnValue) {
                                     if (returnValue == 1) {
                                         if (root.torrentpath == "") {
                                             python.call('main.gettorrentpath',
                                                         [],
                                                         function (returnValue) {
                                                             root.torrentpath = returnValue
                                                             torrentimport.activeConTransfer.items[0].move(
                                                                         root.torrentpath)
                                         ...
                                         myDialog.text = i18n.tr(
                                                     "The torrent you are trying to add is already in the list.")
                                         myDialog.visible = true
                                         torrentimport.activeConTransfer.finalize()
                                     } else {
                                         myDialog.text = i18n.tr(
                                                     "It's not torrent file.")
                                         myDialog.visible = true
                                         torrentimport.activeConTransfer.finalize()
                                     }
                                 })
            ...
            Component.onCompleted: {
                ...
                setHandler('progress', function (returnValue) {
                    ...
                    for (var i = 0; i < listModel.count; i++) {
                        if (String(listModel.get(i).ind) == String(
                                    returnValue[0])) {
                            ind = i
                            break
                        }
    ...
    TransmissionViewer {
        ...
        onTorrentpause: {
            python.call('main.transmission_stop', [transmissionViewer.indx],
                        function () {})
        }
        onTorrentresume: {
            python.call('main.transmission_resume', [transmissionViewer.indx],
                        function () {})
        }
        onTorrentremove: {
            myDialog.text = i18n.tr(
                        "Are you shure remove this torrent and downloaded files?\n")
        ...
        Connections {
            ...
            onClicked: {
                ...
                stack.pop()
                python.call('main.transmission_remove',
                            [transmissionViewer.indx], function () {})
            }
        }
    }
    ExportPage {
